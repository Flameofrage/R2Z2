    ...
    require 'json'
      class R2Z2Twitch
        ...
        def IDLookUp
          ...
          unless $streamer_hash[@server_id].include? @username
            new_streamer = { @server_id => { @username => @id } }
            $streamer_hash.merge!(new_streamer) { |_key, streamer_hash_val, new_streamer_val| streamer_hash_val.merge! new_streamer_val }
